...
public class ObjectCreationButton : MonoBehaviour
{
    public ArbustoFactory arbustoFactory; // Asigna la fábrica de arbustos en el Inspector de Unity.
    ...
    public void CreateArbusto()
    {
        ...
        GameObject createdObject = arbustoFactory.CreateArbusto();
